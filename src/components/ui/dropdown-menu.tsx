...
>(({ className, sideOffset = 8, align = "end", ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      align={align}
      className={cn(
        "dropdown-content z-50 min-w-[12rem] overflow-hidden rounded-xl border border-border bg-background p-1.5 text-foreground premium-shadow",
        "origin-top-right will-change-[opacity,transform]",
        className
      )}
      {...props}
    />
